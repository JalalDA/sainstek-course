  ...
  return (
    <div className='bg-white dark:bg-[#333333]'>
        ...
        <div className="p-4 md:py-16 md:px-32">
                <div className="text-md md:text-2xl font-bold mb-16 text-center">Dapatkan berbagai macam produk <br /> pilihan yang sesuai dengan kebutuhan kamu</div>
                <Fasilitas/>
