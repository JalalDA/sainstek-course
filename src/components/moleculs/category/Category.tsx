...
export default function Category({data, setSelectedCategories} : CategoryProps ) {
  const [selected, setSelected] = useState("Pilih Category")  
  return (
    <div className="my-4 w-full md:w-2/3 z-100">
      <Listbox value={selected} onChange={(selected:any)=>{
        setSelectedCategories(selected?.category_id || "")
